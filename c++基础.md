...
- [1. 类初步认识、对象、字符串](#1-%E7%B1%BB%E5%88%9D%E6%AD%A5%E8%AE%A4%E8%AF%86%E5%AF%B9%E8%B1%A1%E5%AD%97%E7%AC%A6%E4%B8%B2)
...
- [9. 输入/输出流](#9-%E8%BE%93%E5%85%A5%E8%BE%93%E5%87%BA%E6%B5%81)
- [10. 文件](#10-%E6%96%87%E4%BB%B6)
...
4. 重载一元前置与后置运算符：++和--
    C++编译器通过设置哑值区分前置和后置的自增自减运算符。同时，后置自增运算符按值返回对象，因为在自增前需要先返回一个包含原始值的临时对象； 而前置自增运算符按引用返回对象，因为前置自增运算符直接返回自增后的对象。  
